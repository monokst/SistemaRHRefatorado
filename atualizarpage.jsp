...
<html lang="pt-BR">
    <head>
        ...
        <style>
            ...
            * {
            ...
            .section-icon.orange { background: #ffedd5; }
            /* ========== Form Grid ========== */
            .form-grid {
                display: grid;
    ...
    <body>
        ...
        <main class="main">
            ...
            <p class="page-subtitle">Edite os dados do funcionário abaixo. O CPF não pode ser alterado.</p>

            <div class="form-card">
                <h2><span class="badge">✏️</span> Editar Funcionário</h2>
                <p class="form-desc">Todos os campos são obrigatórios.</p>

                <form action="FuncionarioControllerAtualizar" method="post">
                    <input type="hidden" name="op" value="AtualizaFuncionarioAction">
                    ...
                    <input type="hidden" name="id_end" value="<%= f.getEndereco() != null ? f.getEndereco().getId_end() : 0 %>">
                    <input type="hidden" name="id_departamento" value="<%= f.getDepartamento() != null ? f.getDepartamento().getId_departamento() : 0 %>">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group full">
                                ...
                                <input type="text" id="nome" name="nome" value="<%= f.getNome() != null ? f.getNome() : "" %>" required>
                            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label for="nomeDepartamento">Selecione o Departamento</label>
                                <select id="nomeDepartamento" name="nomeDepartamento" required>
                                    <option value="<%= f.getDepartamento() != null ? f.getDepartamento().getNome() : "" %>" selected>
                                        <%= f.getDepartamento() != null ? f.getDepartamento().getNome() : "-- Escolha um departamento --" %>
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="funcao" name="funcao" required>
                                    <option value="<%= f.getDepartamento() != null ? f.getDepartamento().getFuncao() : "" %>" selected>
                                        <%= f.getDepartamento() != null ? f.getDepartamento().getFuncao() : "Selecione" %>
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="salarioBase" name="salarioBase"
                                       value="<%= f.getDepartamento() != null ? f.getDepartamento().getSalarioBase() : "" %>" required>
                            </div>
                        </div>
                    ...
                    <% } else { %>
                    <p style="color: red;">Erro: Nenhum funcionário encontrado para atualização.</p>
                    <% } %>

                    <div class="form-actions">
                        <a href="FuncionarioControllerConsultarTodos?op=ConsultaTodosFuncionarioAction" class="btn btn-outline">Voltar</a>
        ...
        <style>
            ...
            .modal-icon { font-size: 60px; color: #10b981; margin-bottom: 15px; }
        </style>
        ...
        <div id="successModal" class="modal hidden">
            <div class="modal-content">
                ...
                <p>Os dados do funcionário foram atualizados.</p>
